...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", 
        &multihead_attn::self::matmul2::fwd,
	"Self Multihead Attention Matmul2 (Softmax(·) * V) Forward");
  m.def("backward", 
        &multihead_attn::self::matmul2::bwd,
	"Self Multihead Attention Matmul2 (Softmax(·) * V) Backward");
}
