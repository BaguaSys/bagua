...
import unittest
import math
from bagua.torch_api.contrib.fuse.multihead_attn import SelfMultiheadAttnMatmul2Func


class NaiveSelfAttnMatMul2Func(torch.autograd.Function):
    @staticmethod
...
class TestSelfMultiheadAttn(unittest.TestCase):
    def test_self_multihead_attn(self):
        ...
        ref_outputs = NaiveSelfAttnMatMul2Func.apply(
            16, ref_inputs, ref_attention_probs
        )
        tst_outputs = SelfMultiheadAttnMatmul2Func.apply(
